...
new class extends Component {
    ...
    public function mount()
    {
        ...
        if ($settings) {
            ...
            $this->tagline = $settings->store_tagline ?? 'El mayor catálogo de controles remotos y electrónica. Ventas por mayor y menor.';
...
<footer class="w-full mt-auto relative {{ $theme === 'luxury' ? 'bg-[#030712] border-t border-white/5' : 'bg-gray-950 text-gray-400' }} transition-colors duration-300">
    ...
    @else
        ...
        <div class="border-t border-zinc-900 bg-zinc-950 overflow-hidden">
            <div class="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 py-6 md:py-12">
                {{-- Contenedor con Scroll Horizontal en móvil (Swipeable) --}}
                <div class="flex md:grid md:grid-cols-3 gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory hide-scrollbar px-4 sm:px-0 text-center md:divide-x divide-zinc-900">
                    ...
                    <div class="flex flex-col items-center justify-center p-4 min-w-[250px] snap-center bg-zinc-950 md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border md:border-none border-zinc-900">
                        <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-zinc-900 border border-zinc-800 text-g3-blue flex items-center justify-center mb-3 md:mb-4 shadow-[0_0_10px_rgba(0,122,204,0.2)]">
                            <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                        </div>
                        <h4 class="text-xs md:text-sm font-black text-white uppercase tracking-widest mb-1">Retiro por Sucursal</h4>
                        <p class="text-[10px] md:text-xs text-g3-silver font-medium leading-tight">Comprá online y pasá a retirar por nuestro local al instante.</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center p-4 min-w-[250px] snap-center bg-zinc-950 md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border md:border-none border-zinc-900">
                        ...
                        <h4 class="text-xs md:text-sm font-black text-white uppercase tracking-widest mb-1">Compra 100% Segura</h4>
                        <p class="text-[10px] md:text-xs text-g3-silver font-medium leading-tight">Protegemos tus datos y garantizamos tu reserva.</p>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-[10px] text-gray-500 mt-4 italic">* Pagos y entregas se coordinan por WhatsApp.</p>
                </div>
                ...
                <div class="text-center md:text-left">
                    ...
                    <div class="flex flex-row flex-wrap justify-center md:justify-start gap-4 mb-6">
                        ...
                        @endif
                        <a href="mailto:contacto@g3tecnologia.com" class="flex items-center gap-2 text-gray-400 hover:text-g3-blue transition-colors group">
                            <div class="w-8 h-8 shrink-0 rounded-full bg-white/5 border border-white/10 group-hover:bg-blue-500/20 group-hover:border-blue-500/30 flex items-center justify-center transition-colors">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                            </div>
                            <div class="text-left">
                                <span class="block text-[9px] font-bold uppercase tracking-widest text-gray-500">Email</span>
                                <span class="text-xs sm:text-sm font-bold text-gray-300">contacto@g3tecnologia.com</span>
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <div class="flex items-center justify-center md:justify-start gap-3">
                            @if(isset($this->social['instagram']) && !empty($this->social['instagram']))
                                <a href="{{ $this->social['instagram'] }}" target="_blank" title="Instagram" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-600 hover:text-white hover:border-transparent flex items-center justify-center transition-all duration-300 shadow-sm">
                            ...
                            @if(isset($this->social['facebook']) && !empty($this->social['facebook']))
                                <a href="{{ $this->social['facebook'] }}" target="_blank" title="Facebook" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] flex items-center justify-center transition-all duration-300 shadow-sm">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                </a>
                            @endif
                            @if(isset($this->social['tiktok']) && !empty($this->social['tiktok']))
                                <a href="{{ $this->social['tiktok'] }}" target="_blank" title="TikTok" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-white hover:text-black hover:border-white flex items-center justify-center transition-all duration-300 shadow-sm">
