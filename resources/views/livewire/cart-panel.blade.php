                                            ...
                                            @if(isset($products[$productId]))
                                                ...
                                                <li wire:key="cart-item-{{ $productId }}" class="flex py-6 transition-all duration-300"
                                                    ...
                                                    x-data="{ 
                                                        ...
                                                        get isWholesale() {
                                                            return {{ tenant('id') === 'jcg' ? 'this.isVip || globalQuantity >= this.minWholesaleQty' : 'false' }};
                                                        },
                                                ...
                                                >
                                                    <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-2">
                                                        @if($product->image_url)
                                                            <img src="{{ tenant_asset($product->image_url) }}" alt="{{ $product->name }}" class="h-full w-full object-contain mix-blend-multiply dark:mix-blend-normal">
                                                        @else
