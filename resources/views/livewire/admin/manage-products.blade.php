            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div class="flex flex-col lg:flex-row gap-3 w-full sm:w-auto lg:items-center">
                    ...
                    <div class="flex flex-wrap items-center gap-2 w-full lg:w-auto">
                        ...
                        @if(tenant('id') === 'g3')
                            <div class="flex items-center justify-center w-full sm:w-auto gap-1.5 text-[10px] text-gray-500 font-medium whitespace-nowrap bg-white/50 dark:bg-gray-800/50 px-2.5 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm" title="Última actualización de productos">
                                ...
                                Sync: {{ \App\Models\Product::max('updated_at') ? \Carbon\Carbon::parse(\App\Models\Product::max('updated_at'))->timezone('America/Argentina/Buenos_Aires')->format('d/m H:i') : 'Nunca' }}
                            </div>
                        @endif
                    </div>
                </div>
                <div class="flex items-center gap-2 justify-end shrink min-w-0">
                    <!-- Contenedor scrolleable principal -->
                    <div class="flex items-center gap-2 overflow-x-auto flex-nowrap pb-2 pt-1 scroll-smooth" style="scrollbar-width: thin;">
                        
                        <button type="button" @click="massUpdateOpen = true" class="group shrink-0 flex items-center justify-center p-2.5 rounded-full transition-all hover:bg-gray-100 dark:hover:bg-gray-800 border border-slate-200 dark:border-gray-700 shadow-sm text-slate-700 dark:text-slate-200 font-bold">
                        ...
                        <button type="button" @click="brandListOpen = true" class="group shrink-0 flex items-center justify-center p-2.5 rounded-full transition-all hover:bg-gray-100 dark:hover:bg-gray-800 border border-slate-200 dark:border-gray-700 shadow-sm text-slate-700 dark:text-slate-200 font-bold">
                        ...
                        <button type="button" @click="catListOpen = true" class="group shrink-0 flex items-center justify-center p-2.5 rounded-full transition-all hover:bg-gray-100 dark:hover:bg-gray-800 border border-slate-200 dark:border-gray-700 shadow-sm text-slate-700 dark:text-slate-200 font-bold">
                        ...
                        <button type="button" wire:click="syncPrices" class="group shrink-0 flex items-center justify-center p-2.5 rounded-full transition-all hover:bg-emerald-100 dark:hover:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700/50 shadow-sm text-emerald-700 dark:text-emerald-400 font-bold bg-emerald-50 dark:bg-emerald-900/10">
                    ...
                    <!-- Columnas Dropdown (fuera del scroll) -->
                    <div class="relative shrink-0 hidden md:block mb-1">
                        <button @click="colDropdownOpen = !colDropdownOpen" @click.away="colDropdownOpen = false" class="group shrink-0 flex items-center justify-center p-2.5 rounded-full transition-all hover:bg-gray-100 dark:hover:bg-gray-800 border border-slate-200 dark:border-gray-700 shadow-sm text-slate-700 dark:text-slate-200 font-bold">
                                ...
                                <label class="flex justify-between items-center text-gray-700 dark:text-gray-400 text-[10px] sm:text-xs font-bold mb-1.5 uppercase tracking-wider">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div x-data="{ openCatPrompt: false, newCatName: '' }" @click.outside="openCatPrompt = false" class="relative">
                                            ...
                                            <div x-show="openCatPrompt" style="display:none;" x-transition class="absolute z-[60] -left-8 sm:left-auto sm:right-0 top-full mt-2 w-64 sm:w-72 max-w-[90vw] bg-white dark:bg-gray-800 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] border border-gray-200 dark:border-gray-700 p-3">
                                ...
                                <label class="flex justify-between items-center text-gray-700 dark:text-gray-400 text-[10px] sm:text-xs font-bold mb-1.5 uppercase tracking-wider">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div x-data="{ openBrandPrompt: false, newBrandName: '' }" @click.outside="openBrandPrompt = false" class="relative">
                                            ...
                                            <div x-show="openBrandPrompt" style="display:none;" x-transition class="absolute z-[60] right-0 top-full mt-2 w-64 sm:w-72 max-w-[90vw] bg-white dark:bg-gray-800 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] border border-gray-200 dark:border-gray-700 p-3">
