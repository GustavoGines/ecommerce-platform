                        ...
                        <div x-data="{ expanded: false }">
                            <ul class="space-y-3">
                                @if($selectedCategory)
                                    ...
                                    @if($activeCategory)
                                    <li>
                                        <button wire:click="setCategory(null)" class="w-full flex items-center justify-between text-sm transition-colors text-[var(--color-primary)] font-bold bg-[var(--color-primary)]/10 px-3 py-2 rounded-lg border border-[var(--color-primary)]/20 shadow-sm">
                                ...
                                @foreach($visibleCategories->take(5) as $category)
                                    <li>
                                        <button wire:click="setCategory({{ $category->id }})" @click="if(window.innerWidth < 1024) sidebarOpen = false" class="w-full flex items-center justify-between text-sm transition-colors text-gray-600 hover:text-gray-900">
                        ...
                        <div x-data="{ expanded: false }">
                            <ul class="space-y-3">
                                @if($selectedBrand)
                                    ...
                                    @if($activeBrand)
                                    <li>
                                        <button wire:click="setBrand(null)" class="w-full flex items-center justify-between text-sm transition-colors text-[var(--color-primary)] font-bold bg-[var(--color-primary)]/10 px-3 py-2 rounded-lg border border-[var(--color-primary)]/20 shadow-sm">
                                            <span class="flex items-center gap-2">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                                                {{ $activeBrand->name }}
                                            </span>
                                ...
                                @foreach($visibleBrands->take(5) as $brand)
                                    <li>
                                        <button wire:click="setBrand({{ $brand->id }})" @click="if(window.innerWidth < 1024) sidebarOpen = false" class="w-full flex items-center justify-between text-sm transition-colors text-gray-600 hover:text-gray-900">
