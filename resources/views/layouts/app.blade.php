...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @php
            ...
            $logoUrl = $settings->logo_url ? tenant_asset($settings->logo_url) : asset('storage/logos/logo-cjg-horizontal.png');
        ...
        @if(isset($settings) && $settings->favicon_url)
            <link rel="icon" href="{{ tenant_asset($settings->favicon_url) }}">
        @endif
