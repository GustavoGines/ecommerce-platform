...
class TenancyServiceProvider extends ServiceProvider
{
        ...
        return [
            ...
            Events\TenantCreated::class => [
                JobPipeline::make([
                    ...
                    \App\Jobs\CreateTenantDirectories::class,
    ...
    public function boot()
    {
        ...
        // FIX-07: Como el caché de la DB se resuelve antes de inicializar Tenancy,
        // se queda "pegado" a la conexión central. Al limpiar las instancias resueltas,
        ...
        // Forzamos a que el endpoint de actualización de Livewire aplique los
        // middlewares de inicialización de tenant para que los componentes puedan
        // acceder a la base de datos correcta.
